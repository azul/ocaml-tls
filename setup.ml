...
(* OASIS_START *)
(* DO NOT EDIT (digest: e535ec789dcf240afe106121ff367874) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "resume_echo_server.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "resume_client.ml"});
               Executable
                 ({
                     cs_name = "http_client";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "b\178\188\011\134\199 #\204=G\202\213\229\175P";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
